...
class QLearningTable:
    def __init__(self, action_space,learning_rate=0.2, discount=0.9, e_greedy=0, ka=0.4, kb=0.6, beta=0.08):
        ...
        self.e_table = self.import_ETable()
    ...
    def import_QTable(self):
        Q_table = pd.read_csv("/home/miro/mdk/bin/shared/qtable5.csv",index_col=0)
        return Q_table

    def import_ETable(self):
        E_table = pd.read_csv("/home/miro/mdk/bin/shared/etable5.csv",index_col=0)
        return E_table
...
class client_findball_shaping:
    ...
    def save_QTable(self,Q_table):
        Q_table.to_csv("/home/miro/mdk/bin/shared/qtable5.csv")

    def save_ETable(self,E_table):
        E_table.to_csv("/home/miro/mdk/bin/shared/etable5.csv")
